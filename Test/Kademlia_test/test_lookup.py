...
async def run_manual_routing():
    ...
    node1.router.add(NodeData(ip="127.0.0.1", port=8001, id=2))
    node1.router.add(NodeData(ip="127.0.0.1", port=8002, id=3))
...
#     await node2.bootstrap([("127.0.0.1", 9000)])
...
#     node_data = NodeData(ip="127.0.0.1", port=8000, id=1)
